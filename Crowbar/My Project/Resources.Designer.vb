...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a http://steamcommunity.com/id/zeqmacaw.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a Goto Steam Group.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a Goto Steam Profile.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a http://paypal.me/zeqmacaw.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a GoldSource and Source Engine Modding Toolset:
        ...
        '''* Publisher  [resto de la cadena truncado]&quot;;.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a http://steamcommunity.com/groups/CrowbarTool.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a https://steamcommunity.com/groups/CrowbarTool/discussions/1/.
        '''</summary>
        ...
        '''      &lt;Game [resto de la cadena truncado]&quot;;.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a decompile-ANI.txt.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a decompile-MDL.txt.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a decompile-PHY.txt.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a decompile-SequenceGroupMDL.txt.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a decompile-TextureMDL.txt.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a decompile-VTX.txt.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a decompile-VVD.txt.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a decompile-log.txt.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a Possible causes: The game&apos;s SDK or Authoring Tools has not been installed (usually via Steam Library Tools) or the path given to Crowbar (via Set Up Games button) is incorrect..
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a http://steamcommunity.com/sharedfiles/filedetails/?id=791755353.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a https://steamcommunity.com/sharedfiles/workshoplegalagreement.
        '''</summary>
        ...
        '''<summary>
        '''  Busca una cadena traducida similar a unpack-log.txt.
        '''</summary>
